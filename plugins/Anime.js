...
let tk = Config.WORKTYPE == 'public' ? false: true
    ...
    Kingamda.addCommand({pattern: 'anime', fromMe: tk, desc: Lang.ANIM_DESC}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption:'*ඇම්ඩා තමයි හොදටම කරෙ🤪*'})

    }));

    Kingamda.addCommand({pattern: 'anime', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
