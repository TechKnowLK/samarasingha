...
Kingamda.addCommand({pattern: 'break ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({ pattern: 'pubg ?(.*)', fromMe: am,dontAddCommandList: true }, (async (message, match) => {
...
if (match[1].includes(';')) {
  ...
  Kingamda.addCommand({pattern: 'phub ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
   ...
   Kingamda.addCommand({pattern: 'blood ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
    ...
    Kingamda.addCommand({pattern: '2glitch  ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
     ...
     await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
      ...
      Kingamda.addCommand({pattern: 'battle  ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  Kingamda.addCommand({pattern: '1917 ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({ pattern: 'maskman?(.*)', fromMe: am,dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: Config.CAPTIONS})
         ...
         Kingamda.addCommand({pattern: 'boxed ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
  ...
  Kingamda.addCommand({pattern: 'ffire ?(.*)', fromMe: am, dontAddCommandList: false, desc: 'add your text to random freefire logo'}, (async (message, match) => {
  ...
  Kingamda.addCommand({pattern: 'window ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({pattern: 'skywal ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({pattern: 'holo ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
    ...
    Kingamda.addCommand({pattern: '2ninja ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({pattern: 'drop ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({pattern: 'cloud ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 Kingamda.addCommand({pattern: 'emo ?(.*)', fromMe: am, desc: 'emogi to png'}, (async (message, match) => {
    ...
    Kingamda.addCommand({pattern: 'flame ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
    ...
    Kingamda.addCommand({pattern: 'vtext ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
    ...
    Kingamda.addCommand({pattern: 'ptext ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
    ...
    Kingamda.addCommand({pattern: 'colortext ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
   ...
   Kingamda.addCommand({pattern: 'scary ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'glitch ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
 ...
 Kingamda.addCommand({pattern: 'freefire ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'cfire ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'light ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'cslogo ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 's3d ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({ pattern: 'nlogo ?(.*)', fromMe: am,dontAddCommandList: true }, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'blackpink ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'neonlight ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'pornhub ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'bld ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '3dtext ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'nfire ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'ninjalogo ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'nglow ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'nleaves ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'nsky ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'buttonyt ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: 'bcwall ?(.*)', fromMe: am, dontAddCommandList: true}, (async (message, match) => {
