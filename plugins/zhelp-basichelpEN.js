...
if (Config.LANG == 'EN') {
    ...
    Kingamda.addCommand({pattern: 'basichelp', fromMe: true, dontaddCommandList:true}, (async (message, match) => {
...
*ҚɪЛƓ 卂ϻᗪ卂 BASIC Help*
*《《────── « ⋅ʚ♡ɞ⋅ » ──────》》*


Kingamda Bot If you are using (Public) mode then you are only running admin commands.
But for others, all the commands except the admin commands are active ...

Use (.Admin) to get the admin command list
Use (.amda) to get the complete command list.

If you are using Kingamda as Private (.amda) you can use this command to get the command list.
...
Did you know that Kingamda allows you to change Alive message - Alive logo - Welcome Gif - Ban messages - Captions ..
...
*🚀Kingamda Support Groups*
🛡️ https://chat.whatsapp.com/Ish5h9u7qUWLt98HWAYidK

*🛸King Amda Bot News
https://chat.whatsapp.com/E4nzpMwQsqqCOzUeHO0x3s

*🛸King Amda plugging*
https://chat.whatsapp.com/D7mGPt5qOoCLhN5Z9hRwI8
`}) 
