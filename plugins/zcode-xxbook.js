...
Kingamda.addCommand({pattern: '1xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '2xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '3xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '4xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '5xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '6xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
...
Kingamda.addCommand({pattern: '7xst ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
