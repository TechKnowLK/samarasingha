...
function webp2mp4File(path) {
    ...
    Kingamda.addCommand({pattern: 'mp3$', fromMe: tn, desc: Lang.MP4TOAUDİO_DESC}, (async (message, match) => {    
    ...
    Kingamda.addCommand({pattern: 'photo$', fromMe: tn, desc: Lang.STİCKER_DESC}, (async (message, match) => {   
        const mid = message.jid
