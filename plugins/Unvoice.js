...
let tn = Config.WORKTYPE == 'public' ? false : true
  ...
  KingAmda.addCommand({pattern: 'unvoice ?(.*)', fromMe: tn, desc: Lang.UV_DESC}, (async (message, match) => {    
...
KingAmda.addCommand({pattern: 'unvoice', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
