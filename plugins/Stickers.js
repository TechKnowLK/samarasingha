...
if (Config.WORKTYPE == 'private') {
    Kingamda .addCommand({pattern: 'sticker$', fromMe: true, deleteCommand: false,  desc: Lang.STICKER_DESC}, (async (message, match) => {    
    ...
    Kingamda .addCommand({pattern: 'sticker$', fromMe: false, deleteCommand: false, desc: Lang.STICKER_DESC}, (async (message, match) => {    
...
Kingamda .addCommand({pattern: 'sticker$', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
