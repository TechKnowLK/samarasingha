...
KingAmda.addCommand({pattern: 'voice ?(.*)', fromMe: tk, desc: Lang.UV_DESC}, (async (message, match) => {    
...
KingAmda.addCommand({pattern: 'voice ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
    if (message.reply_message === false);
    var location = await message.client.downloadAndSaveMediaMessage({
        key: {
            remoteJid: message.reply_message.jid,
