...
const amda = require('apk-downloader');
...
const Dlang = Language.getString('kingamda');
...
//Kingamda 
    Kingamda.addCommand({pattern: 'trt(?: |$)(\\S*) ?(\\S*)', desc: Lang.TRANSLATE_DESC, usage: Lang.TRANSLATE_USAGE, fromMe: tn}, (async (message, match) => {
...
//Kingamda 
    Kingamda.addCommand({pattern: 'antilink ?(.*)', fromMe: true , desc: l_dsc, usage: '.antilink on / off' }, (async (message, match) => {
...
//Kingamda 
    Kingamda.addCommand({pattern: 'autobio ?(.*)', fromMe: true , desc: auto_dsc, usage: '.autobio on / off' }, (async (message, match) => {
...
//Kingamda 
    Kingamda.addCommand({pattern: 'detectlang$', fromMe: tn, desc: dlang_dsc}, (async (message, match) => {
...
//Kingamda 
    ...
    Kingamda.addCommand({pattern: 'currency(?: ([0-9.]+) ([a-zA-Z]+) ([a-zA-Z]+)|$|(.*))', fromMe: tn}, (async (message, match) => {
...
//Kingamda 
    ...
    if (config.LANG == 'SI' || config.LANG == 'AZ') {
        ...
        Kingamda.addCommand({pattern: 'tts (.*)', fromMe: tn, desc: Lang.TTS_DESC}, (async (message, match) => {
...
/*
//Kingamda 
    Kingamda.addCommand({pattern: 'song ?(.*)', fromMe: tn, desc: Lang.SONG_DESC}, (async (message, match) => { 
...
//Kingamda 
    ...
    Kingamda.addCommand({pattern: 'yt ?(.*)', fromMe: tn, desc: Lang.YT_DESC}, (async (message, match) => { 
...
//Kingamda 
    Kingamda.addCommand({pattern: 'wiki ?(.*)', fromMe: tn, desc: Lang.WIKI_DESC}, (async (message, match) => { 
...
//Kingamda 
Kingamda.addCommand({pattern: 'dcsong ?(.*)', fromMe: tn, desc: Dlang.SONG}, (async (message, match) => { 
...
//Kingamda 
    Kingamda.addCommand({pattern: "covid ?(.*)", fromMe: tn, desc: Clang.COV_DESC}, (async (message, match) => {
        if (match[1] === "") {
            try{
...
/*
Kingamda.addCommand({ pattern: 'apk ?(.*)', fromMe: tn, desc: Dlang.APK_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    var apk = await amda.apk(link)
    var apkinfo = await amda.apk_info(link)
