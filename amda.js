...
const fs = require('fs');
if (fs.existsSync('amda.env')) require('dotenv').hatzu({ path: './amda.env' });
...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'King Amda' : process.env.BOT_NAME,
    HNLOCK: 'hadi-api',
    ZLOCK: 'zeks',
    ZNLOCK: 'zenzapi.xyz',
    ...
    BAPI: process.env.BAPI === undefined ?'xxaCRjUYbu ' : process.env.BAPI,
    ...
    TAPI6: process.env.TAPI6 === undefined ?'SAMARASINGHA5' : process.env.TAPI,
    TAPI7: process.env.TAPI7 === undefined ?'SAMARASINGHA6' : process.env.TAPI,
    TAPI8: process.env.TAPI8 === undefined ?'SAMARASINGHA7' : process.env.TAPI,
    TAPI9: process.env.TAPI9 === undefined ?'SAMARASINGHA8' : process.env.TAPI,
    TAPI10: process.env.TAPI10 === undefined ?'SAMARASINGHA9' : process.env.TAPI,
    TAPI11: process.env.TAPI11 === undefined ?'SAMARASINGHA10' : process.env.TAPI,
    TAPI12: process.env.TAPI12 === undefined ?'SAMARASINGHA11' : process.env.TAPI,
    TAPI13: process.env.TAPI13 === undefined ?'SAMARASINGHA12' : process.env.TAPI,
    AMDA_SITE: process.env.AMDA_SITE === undefined ?'://fzstream.techwizardent.com/' : process.env.AMDA_SITE,
    AMDA_SITEE: process.env.AMDA_SITEE === undefined ?'://netfile2link.herokuapp.com/' : process.env.AMDA_SITEE,
    TAPI15: process.env.TAPI15 === undefined ?'SAMARASINGHA14' : process.env.TAPI,
    TAPI16: process.env.TAPI16 === undefined ?'SAMARASINGHA15' : process.env.TAPI,
    HACKER: process.env.HACKER === undefined ?'Api404' : process.env.HACKER,
    A_HACKER: process.env.A_HACKER === undefined ?'h4ck3rs404-api' : process.env.A_HACKER,
    DEVELOPER: '42 Set Eak Team Work',
    AUTHOR: 'Pasindu Samarasingha',
    GIT: 'https://github.com/Kingamdabota/KingAmda-v2.git',
    HEROKU: {
    ...
    DEBUG: DEBUG,
    LOLKEY:'YTRAMLANID',
    H4CK: 'https://h4ck3rs404-api.herokuapp.com/api/',
